...
— nên `tmux ls` khi ssh tay vào máy vẫn đọc được. Mỗi pane một phiên riêng, không pane
nào soi gương pane nào. Ba tuỳ chọn tmux đều ở phạm vi session nên chết theo session,
không đụng `~/.tmux.conf` của bạn.
