...
| C    | Chia cửa sổ                                | Đã hoàn chỉnh.                        | Workspace grid 1–4 pane, mỗi pane có PTY/focus/resize/cleanup độc lập; Ctrl+Shift+E/O                         | P3          | Tăng số SSH session và tải máy chủ                  | Giới hạn 4 pane; không broadcast input                           |
